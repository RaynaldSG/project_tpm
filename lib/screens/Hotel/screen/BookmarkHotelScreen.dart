...
class BookmarkHotelScreen extends StatefulWidget {

  const BookmarkHotelScreen({super.key});

  @override
  State<BookmarkHotelScreen> createState() => _BookmarkHotelScreenState();
}

class _BookmarkHotelScreenState extends State<BookmarkHotelScreen> {
      ...
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          List<Hotel> hotelsDataRev = hotelController
              .getHotelsData(hotelsData, 'all', _searchController.text);
          hotelsDataRev = hotelsDataRev.where((element) => bookmarkController.checkBookmark(element.id!)).toList();
